...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/projects/', 'Projects'),
        ('/pub/', 'Files'),
        ('http://kwpolska.tk/', 'Blog <i class="fa fa-external-link"></i>'),
        ('http://kwpolska.tk/contact/', 'Contact <i class="fa fa-external-link"></i>'),
...
static site generator<br> copyright&nbsp;©&nbsp;2011–2014&nbsp;<a
