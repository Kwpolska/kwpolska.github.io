...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('https://chriswarrick.com/projects/', 'Projects <i class="fa fa-external-link"></i>'),
        ('/pub/', 'Files'),
        ('https://chriswarrick.com/', 'Blog <i class="fa fa-external-link"></i>'),
        ('https://chriswarrick.com/contact/', 'Contact <i class="fa fa-external-link"></i>'),
...
REDIRECTIONS = [
    ('projects/index.html', 'https://chriswarrick.com/projects/index.html'),
    ('projects/projects.json', 'https://chriswarrick.com/projects/projects.json'),
    ('projects/aurqt/index.html', 'https://chriswarrick.com/projects/aurqt/index.html'),
    ('projects/pkgbuilder/index.html', 'https://chriswarrick.com/projects/pkgbuilder/index.html'),
    ('projects/python-project-template/index.html', 'https://chriswarrick.com/projects/python-project-template/index.html'),
    ('projects/tEmplate/index.html', 'https://chriswarrick.com/projects/tEmplate/index.html'),
    ('projects/img/pkgbuilder.png', 'https://chriswarrick.com/projects/_banners/pkgbuilder.png'),
    ('projects/img/python-project-template.png', 'https://chriswarrick.com/projects/_banners/pypt.'),
]
